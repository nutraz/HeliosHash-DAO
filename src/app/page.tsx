...
import { Award, LogOut, Sun, Users, Wallet, Zap } from 'lucide-react';
      ...
      <div className='gradient-bg flex items-center justify-center p-4'>
        <div className='text-center max-w-md'>
          <div className='flex items-center justify-center gap-3 mb-8'>
            ...
            <h1 className='text-4xl font-bold text-foreground'>HeliosHash DAO</h1>
          </div>
          <p className='text-lg text-muted-foreground mb-8'>Redirecting to authentication...</p>
      ...
      <div className='container mx-auto px-4 py-8 max-w-6xl'>
        ...
        <div className='flex items-center justify-between mb-12'>
          <div className='flex items-center gap-4'>
            ...
            <div>
              <h1 className='text-3xl font-bold text-foreground'>HeliosHash</h1>
              <p className='text-muted-foreground'>Solar Energy DAO</p>
            </div>
          </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-12'>
          <Card
            className='minimal-card p-6 cursor-pointer hover:border-primary/50 transition-colors'
          ...
          >
            <div className='text-center'>
              ...
              <p className='text-muted-foreground mb-4'>
                Support solar infrastructure and earn rewards
              </p>
            ...
            <div className='flex items-center gap-4 p-3 rounded-lg bg-muted/30'>
              ...
              <div className='flex-1'>
                <p className='text-foreground font-medium'>
                  DAO proposal #42 passed with 89% approval
                </p>
