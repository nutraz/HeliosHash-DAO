...
import { idlFactory } from './hhdao_meeting_management.did.js';
export { idlFactory } from './hhdao_meeting_management.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HHDAO_MEETING_MANAGEMENT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hhdao_meeting_management.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hhdao_meeting_management canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hhdao_meeting_management.did.js")._SERVICE>}
 */
export const hhdao_meeting_management = createActor(canisterId);
