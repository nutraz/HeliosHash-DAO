...
import { idlFactory } from './gender_incentives.did.js';
export { idlFactory } from './gender_incentives.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GENDER_INCENTIVES;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./gender_incentives.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the gender_incentives canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./gender_incentives.did.js")._SERVICE>}
 */
export const gender_incentives = createActor(canisterId);
