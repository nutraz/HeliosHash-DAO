...
import { idlFactory } from './hhdao_dao.did.js';
export { idlFactory } from './hhdao_dao.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HHDAO_DAO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hhdao_dao.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hhdao_dao canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hhdao_dao.did.js")._SERVICE>}
 */
export const hhdao_dao = createActor(canisterId);
