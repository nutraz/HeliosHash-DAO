...
export type VerificationLevel = { 'KYC' : null } |
  { 'Enhanced' : null } |
  { 'Email' : null } |
  { 'Basic' : null };
...
export interface _SERVICE {
  ...
  'getUserRoles' : ActorMethod<
    [Principal],
    [] | [{ 'secondary' : Array<Role>, 'primary' : Role }]
  >,
  ...
  'processVerificationRequest' : ActorMethod<
    [bigint, VerificationStatus, [] | [string]],
    Result_3
  >,
  'requestVerification' : ActorMethod<
    [VerificationLevel, [] | [string]],
    Result_2
  >,
  'setAadhaarVerified' : ActorMethod<[], Result>,
  'setDuoValidationPreference' : ActorMethod<[boolean], Result>,
  'setTreasuryCanister' : ActorMethod<[Principal], Result_1>,
