...
import { idlFactory } from './hhdao_frontend.did.js';
export { idlFactory } from './hhdao_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HHDAO_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hhdao_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hhdao_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hhdao_frontend.did.js")._SERVICE>}
 */
export const hhdao_frontend = createActor(canisterId);
