...
/**
 * Render a centered "Page Not Found" (404) UI with a message, branding, and navigation actions.
 *
 * @returns A JSX element containing a styled 404 card with "Go Back" and "Homepage" buttons and a small branding footer.
 */
