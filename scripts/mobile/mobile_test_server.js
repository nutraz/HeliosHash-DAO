...
<head>
  ...
  <title>HHDAO Mobile Test - TEST_USER</title>
    <style>
        body { 
...
<body>
    <div class="container">
        ...
        <div class="user-info">
            <h2>👤 TEST_USER</h2>
            <div class="balance">💰 OWP_BALANCE_PLACEHOLDER OWP</div>
...
server.listen(PORT, HOST, () => {
  ...
  console.log('3. You should see HHDAO mobile interface with TEST_USER data');
