...
export type AlertType = { 'PowerOutage' : null } |
  { 'Custom' : string } |
...
export type DataQuality = { 'Invalid' : null } |
  { 'Good' : null } |
  { 'Poor' : null } |
  { 'Estimated' : null };
...
export type DeviceStatus = { 'Error' : null } |
  { 'Online' : null } |
  { 'Maintenance' : null } |
  { 'Offline' : null };
export type DeviceType = { 'GridConnection' : null } |
  { 'SolarPanel' : null } |
  { 'Battery' : null } |
  { 'EnergyMeter' : null } |
  { 'Inverter' : null } |
...
export type MetricType = { 'SolarIrradiance' : null } |
  { 'Temperature' : null } |
  { 'Humidity' : null } |
  { 'Custom' : string } |
  { 'EnergyProduced' : null } |
...
export type Result = { 'ok' : string } |
  { 'err' : string };
export type Result_1 = { 'ok' : Device } |
  { 'err' : string };
...
export interface _SERVICE {
  ...
  'createManualAlert' : ActorMethod<
    [string, AlertType, Severity, string],
    Result_2
  >,
  'getAggregatedData' : ActorMethod<
    [string, MetricType, TimeRange],
    [] | [AggregatedData]
  >,
  ...
  >,
  'recordData' : ActorMethod<
    [string, Array<[MetricType, number, string]>],
    Result
  >,
