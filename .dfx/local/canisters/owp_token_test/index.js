...
import { idlFactory } from './owp_token_test.did.js';
export { idlFactory } from './owp_token_test.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_OWP_TOKEN_TEST;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./owp_token_test.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the owp_token_test canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./owp_token_test.did.js")._SERVICE>}
 */
export const owp_token_test = createActor(canisterId);
