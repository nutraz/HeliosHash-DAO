...
import { idlFactory } from './hhdao_compute.did.js';
export { idlFactory } from './hhdao_compute.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HHDAO_COMPUTE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hhdao_compute.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hhdao_compute canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hhdao_compute.did.js")._SERVICE>}
 */
export const hhdao_compute = createActor(canisterId);
