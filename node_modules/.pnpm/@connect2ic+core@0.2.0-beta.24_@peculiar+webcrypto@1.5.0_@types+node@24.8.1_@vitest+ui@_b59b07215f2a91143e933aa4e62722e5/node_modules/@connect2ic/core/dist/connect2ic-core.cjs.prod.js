...
var defineProperty = require('./defineProperty-ddf6d5c0.cjs.prod.js');
var xstate = require('xstate');
var agent = require('@dfinity/agent');
var Emitter = require('event-e3');
var neverthrow = require('neverthrow');
var connectors = require('./connectors-76ba3619.cjs.prod.js');
...
const createClient = _ref => {
  ...
  if (config.dev) {
    // TODO: handle errors
    // try {
    agent$1.fetchRootKey().catch(e => console.error(e));
    // } catch (e) {
    //
    // }
  }
