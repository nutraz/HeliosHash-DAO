...
import { ArrowLeft, Plus, MapPin, Zap, Users, Calendar, Filter, Search } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-6">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="p-4 bg-orange-500/10 border border-orange-500/20 rounded-lg">
              ...
              <p className="text-gray-400 text-sm mb-3">Start your own solar project and lead the initiative</p>
              <Button 
                size="sm" 
      ...
      <Tabs defaultValue="all" className="space-y-6">
        ...
        <TabsContent value="funding">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredProjects.filter(p => p.status === 'Funding').map((project) => (
              <Card key={project.id} className="bg-gray-800/50 border-gray-700">
                <CardHeader>
                  <CardTitle className="text-white">{project.name}</CardTitle>
                  <p className="text-gray-400 text-sm">{project.location}</p>
