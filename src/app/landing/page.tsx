  ...
  const features = [
    {
      ...
      description: "Community-owned solar farms generating clean energy for Urgam Valley and surrounding areas."
    },
    {
      icon: Users,
      title: "Decentralized Governance",
      description: "Democratic decision-making through DAO proposals and community voting on all major initiatives."
    },
    {
      icon: Shield,
      title: "Blockchain Security",
      description: "Built on Internet Computer Protocol (ICP) with transparent, immutable smart contracts."
    },
    {
      icon: Globe,
      title: "Community Impact",
      description: "Direct benefits to local families through energy access, job creation, and sustainable development."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-800">
      ...
      <main className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto text-center">
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
                ...
                rural communities through renewable energy, blockchain governance, and sustainable development.
              </p>
        ...
        {/* Impact Section */}
        <section id="impact" className="py-20 px-6 bg-gradient-to-r from-orange-900/20 via-transparent to-green-900/20">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-4">
              ...
              <p className="text-xl text-gray-400 max-w-3xl mx-auto">
                See how HeliosHash DAO is transforming lives in Urgam Valley through 
                sustainable energy and community governance.
              </p>
            </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300">₹2.5 crores invested in local infrastructure</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="card-readable p-8">
                  <div className="text-center">
                    ...
                    <p className="text-gray-300 mb-6">
                      Be part of India's renewable energy revolution. 
                      Your participation helps build sustainable communities 
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-4">
                      <div className={`w-4 h-4 rounded-full ${
                        ...
                        milestone.status === 'active' ? 'bg-orange-500' :
                        'bg-gray-500'
                      }`} />
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge className={
                            ...
                            milestone.status === 'active' ? 'bg-orange-500/20 text-orange-400 border-orange-500/30' :
                            'bg-gray-500/20 text-gray-400 border-gray-500/30'
                          }>
                            {milestone.status === 'completed' ? 'Completed' :
                             milestone.status === 'active' ? 'In Progress' : 'Planned'}
                          </Badge>
                        </div>
      ...
      <footer className="relative z-10 border-t border-gray-700/50 bg-gray-900/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="/projects" className="text-gray-400 hover:text-white transition-colors">Solar Projects</a></li>
                <li><a href="/nft" className="text-gray-400 hover:text-white transition-colors">NFT Marketplace</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-700/50 mt-8 pt-8 text-center">
            <p className="text-gray-400 text-sm">
              © 2025 HeliosHash DAO. Part of the One World Project ecosystem. Building a sustainable future for all.
            </p>
          </div>
        </div>
      </footer>
