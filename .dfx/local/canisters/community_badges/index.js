...
import { idlFactory } from './community_badges.did.js';
export { idlFactory } from './community_badges.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_COMMUNITY_BADGES;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./community_badges.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the community_badges canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./community_badges.did.js")._SERVICE>}
 */
export const community_badges = createActor(canisterId);
