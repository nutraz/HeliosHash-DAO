...
export default function JobFiltersPanel({ filters, onFiltersChange, className }: JobFiltersPanelProps) {
          ...
          {EXPERIENCE_LEVELS.map(level => (
            <div key={level.value} className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={() => 
                  addToArrayFilter('experienceLevel', level.value, filters.experienceLevel as string[])
                }
              />
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) => updateFilter('minCompensation', Number(e.target.value) || undefined)}
              />
            </div>
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) => updateFilter('maxCompensation', Number(e.target.value) || undefined)}
              />
            </div>
          </div>
