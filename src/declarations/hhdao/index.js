...
import { idlFactory } from './hhdao.did.js';
export { idlFactory } from './hhdao.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HHDAO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hhdao.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hhdao canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hhdao.did.js")._SERVICE>}
 */
export const hhdao = createActor(canisterId);
