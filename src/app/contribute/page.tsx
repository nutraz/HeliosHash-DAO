...
const mockOpportunities: InvestmentOpportunity[] = [
  {
    ...
    category: 'solar-farm',
    description:
      'Large-scale solar farm project in high-irradiance desert region with government backing and 25-year PPA.',
    highlights: [
  ...
  },
  {
    ...
    description:
      'Portfolio of 500+ residential rooftop installations across Mumbai with net metering benefits.',
    highlights: [
  ...
  },
  {
    ...
    category: 'commercial',
    description:
      'Combined solar and battery storage system for industrial complex with captive power model.',
    highlights: [
...
/**
 * Renders the Investment Hub page containing opportunity listings, filters, ROI calculator placeholder, portfolio view, and investor tiers.
 *
 * The component manages local UI state for active tab, category and risk filters, investment amount input, and selected opportunity. It provides helper utilities for currency formatting, risk badge styling, category icons, opportunity filtering, and tier lookup.
 *
 * @returns The JSX element for the contribution/investment interface
 */
                  ...
                  <div>
                    ...
                    <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                      ...
                      <SelectContent className='bg-gray-700 border-gray-600'>
                        ...
                        <SelectItem value='solar-farm' className='text-white'>
                          Solar Farms
                        </SelectItem>
                        ...
                        <SelectItem value='infrastructure' className='text-white'>
                          Infrastructure
                        </SelectItem>
                      </SelectContent>
                    </Select>
            ...
            <div className='space-y-6'>
              {filteredOpportunities.map((opportunity) => {
                ...
                return (
                  <Card
                    key={opportunity.id}
                    className='bg-gray-800/50 border-gray-700 hover:border-green-500/30 transition-colors'
                  >
                    <CardContent className='p-6'>
                        ...
                        <div className='space-y-2'>
                          {opportunity.timeline.map((phase, index) => (
                            <div key={index} className='flex items-center justify-between'>
                              ...
                              <div className='text-sm text-gray-400 ml-4 w-20'>
                                {phase.expectedDate}
                              </div>
                            </div>
                          ))}
