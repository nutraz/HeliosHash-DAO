  ...
  try {
    ...
    if (nftId) {
      ...
      const nft: NFT = {
        ...
        metadata: {
          name: "Solar Pioneer",
          description: "Exclusive NFT for early supporters of HeliosHash DAO solar mining initiatives",
    ...
    if (collectionId) {
      ...
      const collection: NFTCollection = {
        ...
        description: "A collection of achievement NFTs awarded to active contributors in the HeliosHash ecosystem",
