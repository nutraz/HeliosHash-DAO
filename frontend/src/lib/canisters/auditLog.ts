...
import { canisterId as auditLogCanisterId } from '@declarations/audit_log_canister';
...
export function getAuditLogActor() {
  try {
    ...
    // Use the generated declarations path via the TS path alias
    // eslint-disable-next-line @typescript-eslint/no-var-requires
    return createActor(auditLogCanisterId, require('@declarations/audit_log_canister').idlFactory);
  } catch (e) {
    const stub = {
