...
const HHDAOThemePreview: React.FC = () => {
  ...
  useEffect(() => {
    if (typeof document !== 'undefined') {
      document.documentElement.style.setProperty('--hh-glow-intensity', String(glowIntensity));
      document.documentElement.style.setProperty('--hh-animation-speed', `${animationSpeed}s`);
    }
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4 mb-12">
          <div className="flex items-center justify-center space-x-4 mb-4">
            <div className="relative">
              <div className="absolute inset-0 bg-orange-500 blur-xl opacity-50 animate-pulse rounded-full w-24 h-24" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
            ...
            <div className="space-y-3">
              <div className="relative group">
                <div className="absolute inset-0 bg-orange-500 blur-2xl opacity-50 group-hover:opacity-75 transition-opacity rounded-2xl" />
                <div className="relative h-32 bg-gradient-to-br from-orange-400 to-orange-600 rounded-2xl shadow-xl shadow-orange-500/50" />
              </div>
            ...
            <div className="space-y-3">
              <div className="relative group">
                <div className="absolute inset-0 bg-white blur-2xl opacity-30 group-hover:opacity-50 transition-opacity rounded-2xl" />
                <div className="relative h-32 bg-gradient-to-br from-white to-gray-100 rounded-2xl shadow-xl" />
              </div>
              <div className="text-center">
            ...
            <div className="space-y-3">
              <div className="relative group">
                <div className="absolute inset-0 bg-green-500 blur-2xl opacity-50 group-hover:opacity-75 transition-opacity rounded-2xl" />
                <div className="relative h-32 bg-gradient-to-br from-green-400 to-green-600 rounded-2xl shadow-xl shadow-green-500/50" />
              </div>
              <div className="text-center">
            ...
            <div className="space-y-3">
              <div className="relative group">
                <div className="absolute inset-0 bg-blue-600 blur-2xl opacity-50 group-hover:opacity-75 transition-opacity rounded-2xl" />
                <div className="relative h-32 bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl shadow-xl shadow-blue-600/50" />
              </div>
              <div className="text-center">
            ...
            <div className="space-y-3">
              <div className="relative group">
                <div className="h-32 bg-gradient-to-br from-gray-800 to-gray-950 rounded-2xl shadow-xl border border-gray-700" />
              </div>
              <div className="text-center">
        ...
        <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <button className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-orange-500 to-orange-600 blur-lg opacity-75 group-hover:opacity-100 transition-all group-hover:blur-xl rounded-2xl" />
            ...
            {/* Success Button */}
            <button className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-green-500 to-green-600 blur-lg opacity-75 group-hover:opacity-100 transition-all group-hover:blur-xl rounded-2xl" />
            ...
            {/* Info Button */}
            <button className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-700 blur-lg opacity-75 group-hover:opacity-100 transition-all group-hover:blur-xl rounded-2xl" />
            ...
            {/* Ghost Button */}
            <button className="relative group">
              <div className="absolute inset-0 bg-white blur-lg opacity-20 group-hover:opacity-40 transition-all rounded-2xl" />
        ...
        <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="relative group overflow-hidden rounded-2xl">
              <div className="absolute inset-0 bg-gradient-to-br from-orange-500/20 to-orange-600/20 blur-xl" />
            ...
            {/* Community Card */}
            <div className="relative group overflow-hidden rounded-2xl">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600/20 to-blue-700/20 blur-xl" />
        ...
        <div className="relative overflow-hidden rounded-3xl">
          ...
          <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-700 p-12">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <p className="text-2xl text-gray-300">Join the renewable energy revolution with blockchain technology</p>
              <div className="flex justify-center space-x-4 mt-8">
                <button className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-r from-orange-500 to-green-500 blur-lg opacity-75 group-hover:opacity-100 transition-all rounded-2xl"></div>
        ...
        <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="flex flex-wrap gap-4">
            <span className="relative group">
              <div className="absolute inset-0 bg-green-500 blur-md opacity-50 group-hover:opacity-75 transition-opacity rounded-full"></div>
              <div className="relative bg-green-500/20 border border-green-500 text-green-400 px-6 py-2 rounded-full font-semibold">✓ Functioning</div>
            </span>
            <span className="relative group">
              <div className="absolute inset-0 bg-orange-500 blur-md opacity-50 group-hover:opacity-75 transition-opacity rounded-full"></div>
              <div className="relative bg-orange-500/20 border border-orange-500 text-orange-400 px-6 py-2 rounded-full font-semibold animate-pulse">⚡ In Progress</div>
            </span>
            <span className="relative group">
              <div className="absolute inset-0 bg-blue-600 blur-md opacity-50 group-hover:opacity-75 transition-opacity rounded-full"></div>
              <div className="relative bg-blue-600/20 border border-blue-600 text-blue-400 px-6 py-2 rounded-full font-semibold">🔧 Setup Phase</div>
            </span>
            <span className="relative group">
              <div className="absolute inset-0 bg-white blur-md opacity-30 group-hover:opacity-50 transition-opacity rounded-full"></div>
              <div className="relative bg-white/10 border border-white/30 text-white px-6 py-2 rounded-full font-semibold">📋 Applied</div>
            </span>
          </div>
        </div>
        ...
        <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="space-y-4 max-w-2xl">
            <div className="relative group">
              <div className="absolute inset-0 bg-orange-500/20 blur-lg opacity-0 group-focus-within:opacity-100 transition-opacity rounded-xl"></div>
              <input type="text" placeholder="Enter your wallet address..." className="relative w-full bg-gray-800 border-2 border-gray-700 focus:border-orange-500 text-white px-6 py-4 rounded-xl outline-none transition-all placeholder-gray-500" />
            </div>
            <div className="relative group">
              <div className="absolute inset-0 bg-green-500/20 blur-lg opacity-0 group-focus-within:opacity-100 transition-opacity rounded-xl"></div>
              <input type="number" placeholder="Amount (HHU Tokens)" className="relative w-full bg-gray-800 border-2 border-gray-700 focus:border-green-500 text-white px-6 py-4 rounded-xl outline-none transition-all placeholder-gray-500" />
            </div>
          </div>
        </div>
