...
var classPrivateFieldGet = require('../../../dist/classPrivateFieldGet-e4c7cfd2.cjs.prod.js');
var defineProperty = require('../../../dist/defineProperty-ddf6d5c0.cjs.prod.js');
var sdkWeb = require('@astrox/sdk-web');
var types = require('@astrox/connection/lib/esm/types');
var neverthrow = require('neverthrow');
var connectors = require('../../../dist/connectors-76ba3619.cjs.prod.js');
var types$1 = require('@astrox/sdk-web/build/types');
...
class AstroX {
  ...
  get wallets() {
    return classPrivateFieldGet._classPrivateFieldGet(this, _wallet) ? [classPrivateFieldGet._classPrivateFieldGet(this, _wallet)] : [];
  }
  constructor() {
  ...
  set config(config) {
    classPrivateFieldGet._classPrivateFieldSet(this, _config, {
      ...classPrivateFieldGet._classPrivateFieldGet(this, _config),
      ...config
    });
  }
  get config() {
  ...
  async init() {
    try {
      const ic = await sdkWeb.IC.create({
        ...
        signerProviderUrl: `${classPrivateFieldGet._classPrivateFieldGet(this, _config).providerUrl}/#signer`,
        walletProviderUrl: `${classPrivateFieldGet._classPrivateFieldGet(this, _config).providerUrl}/#transaction`,
        identityProvider: `${classPrivateFieldGet._classPrivateFieldGet(this, _config).providerUrl}/#authorize`,
        ...
        delegationModes: classPrivateFieldGet._classPrivateFieldGet(this, _config).delegationModes,
        noUnify: classPrivateFieldGet._classPrivateFieldGet(this, _config).noUnify,
        customDomain: classPrivateFieldGet._classPrivateFieldGet(this, _config).customDomain
      });
      classPrivateFieldGet._classPrivateFieldSet(this, _ic, window.ic.astrox ?? ic);
  ...
  async createActor(canisterId, idlFactory) {
    try {
      ...
      // @ts-ignore
      const actor = await classPrivateFieldGet._classPrivateFieldGet(this, _ic).createActor(idlFactory, canisterId);
      // @ts-ignore
  ...
  async disconnect() {
    try {
      await classPrivateFieldGet._classPrivateFieldGet(this, _ic)?.disconnect();
      return neverthrow.ok(true);
    } catch (e) {
      console.error(e);
      return neverthrow.err({
  ...
  async requestTransfer(opts) {
    ...
    try {
      const result = await classPrivateFieldGet._classPrivateFieldGet(this, _ic)?.requestTransfer({
  ...
  async requestTransferNFT(args) {
    try {
      ...
      if (!response || typeof response === "string" || response.kind === types$1.TransactionMessageKind.fail) {
        return neverthrow.err({
          kind: connectors.TransferError.TransferFailed
        });
      }
      if (response.kind === types$1.TransactionMessageKind.success) {
        return neverthrow.ok({
          // TODO: fix
          ...response.payload
  ...
  async queryBalance() {
    try {
      const ICPBalance = Number(await classPrivateFieldGet._classPrivateFieldGet(this, _ic)?.queryBalance()) ?? 0;
      return neverthrow.ok([{
