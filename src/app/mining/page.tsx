...
import { Zap, TrendingUp, Thermometer, Waves, Bitcoin, RefreshCw } from "lucide-react";
...
export default function MiningPage() {
  ...
  const getOperationTypeIcon = (type: string) => {
    switch (type) {
      case "bitcoin_asic": return <Bitcoin className="h-5 w-5 text-orange-500" />;
      case "immersion_cooling": return <Waves className="h-5 w-5 text-cyan-500" />;
          ...
          <Card className="minimal-card p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-foreground">{miningData.energyGenerated} MW</p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between text-sm mb-2">
                      ...
                      <span className="font-medium text-foreground">{formatNumber(miningData.totalHashrate)} TH/s</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-2">
                      ...
                      <span className="font-medium text-foreground">{miningData.thermalEfficiency}%</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-2">
                      ...
                      <span className="font-medium text-foreground">{miningData.heatUtilized}%</span>
                    </div>
              ...
              <Card className="minimal-card p-6">
                ...
                <div className="space-y-3">
                  ...
                  <Button variant="outline" className="w-full">Add Bitcoin ASIC Farm</Button>
                  <Button variant="outline" className="w-full">Configure Heat Recovery</Button>
                </div>
              </Card>
            </div>
          </TabsContent>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className={`w-3 h-3 rounded-full ${
                          ...
                          miner.status === "maintenance" ? "bg-yellow-500" : "bg-red-500"
                        }`}></div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium text-foreground">{formatNumber(miner.hashrate)} TH/s</span>
                      </div>
                      <div className="flex justify-between text-sm">
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium text-foreground">₹{formatNumber(miner.rewards)}</span>
                      </div>
                    </div>
                    
                    <div className="flex justify-between items-center">
                      <Badge className={getStatusColor(miner.status)}>
                        {miner.status}
                      </Badge>
            ...
            <Card className="minimal-card p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="text-center p-4 rounded-lg india-green">
                  <p className="text-2xl font-bold">₹1.36M</p>
