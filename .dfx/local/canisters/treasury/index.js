...
export const canisterId = process.env.CANISTER_ID_TREASURY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./treasury.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the treasury canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./treasury.did.js")._SERVICE>}
 */
export const treasury = createActor(canisterId);
