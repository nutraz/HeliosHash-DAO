...
import { idlFactory } from './hhdao_identity.did.js';
export { idlFactory } from './hhdao_identity.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HHDAO_IDENTITY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hhdao_identity.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hhdao_identity canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hhdao_identity.did.js")._SERVICE>}
 */
export const hhdao_identity = createActor(canisterId);
