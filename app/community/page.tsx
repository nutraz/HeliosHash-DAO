...
export default function CommunityPage() {
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-bold mb-6 text-navy-900">Community Initiatives</h1>
      ...
      <Tabs defaultValue="animal-care" className="w-full">
        ...
        <TabsContent value="animal-care" className="mt-6">
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-semibold mb-4 text-navy-800">Animal Care Initiative</h2>
