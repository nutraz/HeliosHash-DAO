...
export { idlFactory } from './hhdao_documents.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HHDAO_DOCUMENTS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hhdao_documents.did.js")._SERVICE>}
 */
 ...
 */
export const hhdao_documents = createActor(canisterId);
