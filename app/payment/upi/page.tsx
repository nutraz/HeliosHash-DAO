...
export default function UPIPaymentPage() {
  ...
  const [step, setStep] = useState<'amount' | 'kyc' | 'payment' | 'processing' | 'success' | 'error'>('amount');
  const [paymentError, setPaymentError] = useState('');

  const tokenBalance = 2000.00; // Mock balance
    ...
    <main role="main">
      <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow">
        ...
        <div className="mb-4">
          ...
          <p className="text-lg font-semibold" data-testid="owp-tokens">{tokenBalance.toFixed(2)} OWP</p>
        </div>
        ...
        {step === 'kyc' && (
          <div className="space-y-4">
            ...
            {paymentError && (
              <div className="p-3 bg-red-50 border border-red-200 rounded-md" data-testid="kyc-limit-error">
