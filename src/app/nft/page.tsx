...
import { ArrowLeft, Image, Star, Zap, Award } from 'lucide-react';
        ...
        {mockNFTs.map((nft) => (
          <Card key={nft.id} className="bg-gray-800/50 border-gray-700 overflow-hidden">
            <CardContent className="p-0">
              ...
              <div className={`h-48 bg-gradient-to-br ${nft.gradient} flex items-center justify-center`}>
                <div className="text-center text-white">
                  <Image className="w-16 h-16 mx-auto mb-2 opacity-75" />
              ...
              <div className="p-4">
                <div className="flex items-center justify-between mb-3">
                  <Badge variant={
                    ...
                    nft.rarity === 'Epic' ? 'secondary' : 'outline'
                  }>
                    {nft.rarity}
                  </Badge>
