...
export type DisputeCategory = { 'TreasuryDispute' : null } |
...
export type DisputePriority = { 'Low' : null } |
  { 'High' : null } |
  { 'Medium' : null } |
  { 'Critical' : null };
...
export type EvidenceType = { 'Transaction' : null } |
  { 'Communication' : null } |
  { 'Document' : null } |
  { 'Testimony' : null } |
  { 'Other' : string } |
...
export interface _SERVICE {
  ...
  'scheduleMediationSession' : ActorMethod<
    [DisputeId, Time, Array<Principal>],
    Result
  >,
