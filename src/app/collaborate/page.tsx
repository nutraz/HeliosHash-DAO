...
import { ArrowLeft, Users, Award, Clock, MapPin, DollarSign, Search, Filter, Star, MessageCircle, ChevronRight, Zap, Wrench, Cpu, BarChart } from 'lucide-react';
...
const mockOpportunities: Opportunity[] = [
  {
    ...
    description: 'Design a 500kW solar installation for rural community with grid-tie capabilities and battery backup.',
    urgency: 'high',
    remote: true,
  ...
  },
  {
    ...
    skillsRequired: ['Solar Installation', 'Electrical Systems', 'Safety Protocols', 'Project Management'],
    description: 'Lead installation team for innovative agri-solar system combining farming with solar generation.',
    urgency: 'medium',
    remote: false,
  ...
  },
  {
    ...
    description: 'Develop IoT-based monitoring and analytics platform for distributed solar installations.',
    urgency: 'low',
    remote: true,
  ...
  },
  {
    ...
    skillsRequired: ['Solar Maintenance', 'Troubleshooting', 'Inverter Systems', 'Performance Analysis'],
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-400">Connect with solar projects and contribute your expertise</p>
            </div>
          </div>
        </div>
          ...
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {opportunityTypes.map((type) => {
                ...
                return (
                  <div key={type.value} className="flex flex-col items-center p-3 bg-gray-800/30 rounded-lg">
          ...
          <TabsContent value="opportunities">
                  ...
                  <div>
                    <Select value={selectedLocation} onValueChange={setSelectedLocation}>
                      ...
                      <SelectContent className="bg-gray-700 border-gray-600">
                        ...
                        <SelectItem value="Rajasthan" className="text-white">Rajasthan</SelectItem>
            ...
            <div className="space-y-4">
              {filteredOpportunities.map((opportunity) => {
                ...
                return (
                  <Card key={opportunity.id} className="bg-gray-800/50 border-gray-700 hover:border-blue-500/30 transition-colors">
                    <CardContent className="p-6">
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="text-right">
                          <div className="text-green-400 font-semibold mb-1">{opportunity.budget}</div>
                          <div className="text-gray-400 text-sm">{opportunity.applicants} applicants</div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <div className="flex items-center text-gray-300">
                          ...
                          {opportunity.remote && (
                            <Badge className="ml-2 bg-blue-500/20 text-blue-400 text-xs">Remote</Badge>
                          )}
                        </div>
              ...
              <CardContent className="p-6">
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-400 mb-6">
                    Set up your technical expertise profile to get matched with relevant opportunities
                  </p>
