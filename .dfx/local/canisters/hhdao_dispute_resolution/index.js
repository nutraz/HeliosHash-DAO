...
import { idlFactory } from './hhdao_dispute_resolution.did.js';
export { idlFactory } from './hhdao_dispute_resolution.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HHDAO_DISPUTE_RESOLUTION;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hhdao_dispute_resolution.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hhdao_dispute_resolution canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hhdao_dispute_resolution.did.js")._SERVICE>}
 */
export const hhdao_dispute_resolution = createActor(canisterId);
