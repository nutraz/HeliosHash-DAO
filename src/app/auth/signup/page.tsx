...
export default function SignupPage() {
  ...
  const [loginMethod, setLoginMethod] = useState<'internet-identity' | 'wallet'>(
    'internet-identity'
  );
  ...
  const handleAuth = async () => {
    try {
      ...
      if (loginMethod === 'internet-identity') {
        // Login expects either a credentials object or special string token for Internet Identity
        await login('internet-identity');
      } else if (selectedWallet) {
        // Normalize to credentials object shape expected by login()
        await login({ type: 'wallet', walletType: selectedWallet });
      } else {
        return;
      }
    ...
    <div className='min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-800 flex items-center justify-center p-6'>
      ...
      <div className='relative z-10 w-full max-w-lg'>
        ...
        <div className='text-center mb-8'>
          ...
          <p className='text-gray-400'>Become part of India's renewable energy revolution</p>
        </div>
              ...
              {loginMethod === 'internet-identity' && (
                <div className='space-y-4'>
                  <div className='text-center text-sm text-gray-400 mb-4'>
                    Create or use your Internet Computer identity for secure, anonymous
                    authentication
                  </div>
                  <Button
                    onClick={handleAuth}
            ...
            <CardContent className='space-y-6'>
              <div className='text-center'>
                ...
                <p className='text-gray-300 mb-6'>
                  Identity connected successfully! Now join the HeliosHash DAO to access all
                  features and start participating in community governance.
                </p>
              </div>
            ...
            <CardContent className='space-y-6'>
              <div className='text-center'>
                ...
                <p className='text-gray-300 mb-4'>
                  Congratulations! You're now a member of HeliosHash DAO. You've received your
                  membership NFT and can start participating in governance.
                </p>
              </div>
