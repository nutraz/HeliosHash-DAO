    ...
    <div className="min-h-screen app-container p-4 pb-20">
        ...
        <CardContent className="p-6">
          ...
          <div className="mt-6 space-y-3">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold text-white">{dailyGeneration.toFixed(1)} / 25 kWh</span>
            </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <ActionCard 
          icon="☀️"
          title="Solar Panels"
          description="12 panels • 3.6kW capacity"
        />
        
        <ActionCard 
          icon={Battery}
          title="Battery Storage"
          description="15kWh • 73% charged"
        />
        
        <ActionCard 
          icon={Home}
          title="Home Usage"
          description="1.2kW • Real-time"
        />
        
        <ActionCard 
          icon={Factory}
          title="Grid Export"
          description="1.4kW • To community"
        />
      </div>
      ...
      <Tabs defaultValue="live" className="w-full">
        <TabsList className="grid w-full grid-cols-3 bg-gray-800">
          <TabsTrigger value="live" className="data-[state=active]:bg-gray-700 text-white">⚡ Live</TabsTrigger>
          <TabsTrigger value="history" className="data-[state=active]:bg-gray-700 text-white">📊 History</TabsTrigger>
          <TabsTrigger value="forecast" className="data-[state=active]:bg-gray-700 text-white">🌤️ Forecast</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="live" className="space-y-3">
          <Card className="card-readable">
            ...
            <CardContent className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-300">Solar Generation</span>
                <span className="font-semibold text-green-400">{currentGeneration.toFixed(1)} kW</span>
              </div>
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-yellow-400">{(currentGeneration - 1.2).toFixed(1)} kW</span>
              </div>
              <div className="flex justify-between items-center">
        ...
        <TabsContent value="history" className="space-y-3">
          <Card className="card-readable">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-300">Grid Export</span>
                <span className="font-semibold text-white">{(dailyGeneration - 8.4).toFixed(1)} kWh</span>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
