...
import { idlFactory } from './hhdao_telemetry.did.js';
export { idlFactory } from './hhdao_telemetry.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HHDAO_TELEMETRY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hhdao_telemetry.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hhdao_telemetry canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hhdao_telemetry.did.js")._SERVICE>}
 */
export const hhdao_telemetry = createActor(canisterId);
