export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'getDuoValidationPreference' : IDL.Func(
        [IDL.Principal],
        [IDL.Bool],
        ['query'],
      ),
    ...
    'getUserRoles' : IDL.Func(
        ...
        [
          IDL.Opt(
            IDL.Record({ 'secondary' : IDL.Vec(Role), 'primary' : Role })
          ),
        ],
        ['query'],
      ),
    'getUsersWithDuoPreference' : IDL.Func(
        [],
    ...
    'requestVerification' : IDL.Func(
        [VerificationLevel, IDL.Opt(IDL.Text)],
        [Result_2],
        [],
      ),
    'setAadhaarVerified' : IDL.Func([], [Result], []),
    'setDuoValidationPreference' : IDL.Func([IDL.Bool], [Result], []),
    'setTreasuryCanister' : IDL.Func([IDL.Principal], [Result_1], []),
