      ...
      setPosts([
        {
          ...
          author: 'Rajesh Kumar',
          content:
            'Excited to announce our new solar farm in Gujarat! This 50MW facility will power over 20,000 homes.',
        ...
        },
        {
          ...
          author: 'Priya Sharma',
          content:
            'Just completed the installation of solar panels on my rooftop. The process was smooth!',
        ...
        },
        {
          ...
          author: 'Amit Patel',
          content:
            'Looking for collaborators for a community solar project in Mumbai. DM if interested!',
          timestamp: '1 day ago',
          likes: 28,
          comments: 15,
      ...
      <div className='container mx-auto px-4 py-8 max-w-6xl'>
        ...
        <Tabs defaultValue='feed' className='space-y-6'>
          ...
          <TabsContent value='feed' className='space-y-4'>
            {/* Validation Opportunities Summary */}
            <ValidationSummary
              onViewAll={() => {
                // Switch to opportunities tab and validations sub-tab
          ...
          <TabsContent value='opportunities' className='space-y-4'>
            <Tabs defaultValue='validations' className='space-y-6'>
              <TabsList className='grid w-full grid-cols-2'>
                <TabsTrigger value='validations'>Solar Validations</TabsTrigger>
              ...
              <TabsContent value='validations'>
                <ValidationOpportunities
                  onApply={(opportunityId, sessionType) => {
                    console.log(`Applied for validation ${opportunityId} as ${sessionType}`);
                    // Here you could show a success toast or redirect
                  }}
                />
              </TabsContent>
              ...
              <div className='text-center space-y-4'>
                ...
                <div>
                  ...
                  <p className='text-muted-foreground mb-4'>
                    Start a new solar energy, mining, or infrastructure project in your community
                  </p>
                    ...
                    <DialogContent className='sm:max-w-[600px] max-h-[80vh] overflow-y-auto bg-background/95 backdrop-blur-sm border shadow-lg'>
                      <DialogHeader className='space-y-3'>
                        ...
                        <DialogDescription className='text-muted-foreground'>
                          Fill in the details to create a new community project. All required fields
                          must be completed.
                        </DialogDescription>
                      </DialogHeader>
                          ...
                          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                            ...
                            <div className='space-y-2'>
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setNewProject({ ...newProject, landOwner: e.target.value })
                                }
                              />
                            </div>
                          </div>
                          ...
                          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                            ...
                            <div className='space-y-2'>
                              ...
                              <Select
                                ...
                                onValueChange={(value) =>
                                  setNewProject({ ...newProject, type: value as any })
                                }
                              >
                                <SelectTrigger>
                          ...
                          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                            <div className='space-y-2'>
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setNewProject({ ...newProject, landSize: e.target.value })
                                }
                              />
                            </div>
                            <div className='space-y-2'>
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setNewProject({ ...newProject, expectedEnergy: e.target.value })
                                }
                              />
                            </div>
                          </div>
                          ...
                          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                            <div className='space-y-2'>
                              ...
                              <Select
                                ...
                                onValueChange={(value) =>
                                  setNewProject({ ...newProject, investmentType: value as any })
                                }
                              >
                                <SelectTrigger>
                                  <SelectValue />
                            ...
                            <div className='space-y-2'>
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setNewProject({ ...newProject, roi: e.target.value })
                                }
                              />
                            </div>
                            <div className='space-y-2'>
                              ...
                              <Select
                                value={newProject.sustainability}
                                onValueChange={(value) =>
                                  setNewProject({ ...newProject, sustainability: value as any })
                                }
                              >
                                <SelectTrigger>
                  ...
                  <div className='flex items-start justify-between'>
                    <div className='flex-1'>
                      ...
                      <p className='text-muted-foreground mb-2'>
                        📍 {project.location} • 👤 {project.landOwner}
                      </p>
            ...
            <div className='grid gap-6'>
              <div className='bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20'>
                ...
                <p className='text-gray-300 mb-6'>
                  File disputes, participate in voting, and help resolve community conflicts through
                  our decentralized arbitration system.
                </p>
                <DisputeResolution />
              </div>
            </div>
