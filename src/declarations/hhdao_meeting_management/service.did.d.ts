...
export type AttendeeRole = { 'Participant' : null } |
  { 'Speaker' : null } |
  { 'Organizer' : null } |
  { 'Observer' : null };
...
export type MeetingStatus = { 'Scheduled' : null } |
  { 'Cancelled' : null } |
  { 'InProgress' : null } |
  { 'Completed' : null };
...
export type MeetingType = { 'ProjectReview' : null } |
  { 'GovernanceCall' : null } |
...
export type Result = { 'ok' : boolean } |
  { 'err' : string };
export type Result_1 = { 'ok' : MeetingId } |
  { 'err' : string };
...
export interface _SERVICE {
  ...
  'addTranscriptSegment' : ActorMethod<
    [MeetingId, string, [] | [string], [] | [number]],
    Result_2
  >,
