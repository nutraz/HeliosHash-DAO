...
import { idlFactory } from './owp_token.did.js';
export { idlFactory } from './owp_token.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_OWP_TOKEN;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./owp_token.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the owp_token canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./owp_token.did.js")._SERVICE>}
 */
export const owp_token = createActor(canisterId);
