...
const HHDAODashboard: React.FC = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      opportunities: [
        { type: "Mining Technician", positions: 2 },
        { type: "Energy Engineer", positions: 1 },
        { type: "Web3 Developer", positions: 1 }
      ],
      detailedInfo: {
        ...
        milestones: [
          { date: "Q1 2024", event: "DPR Approved & Landowner Agreement Signed" },
          { date: "Q2 2024", event: "Phase 1 Deployment - 50kW Live" },
          { date: "Q4 2024", event: "DAO Integration & RWA Module Launch" },
          { date: "2025-2026", event: "Scaling to 200kW → 500kW" }
        ],
        impact: {
          co2Offset: "Natural cooling reduces energy by 90%",
          btcGenerated: "~0.15 BTC/month (Phase 1)",
          landownerEarnings: "₹2.34 Cr over 10 years",
          jobsCreated: 6
        }
      }
    }
