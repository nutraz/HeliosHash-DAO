      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center space-x-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-400">Join HeliosHash DAO as a land partner for solar projects</p>
          </div>
        </div>
          ...
          <CardContent className="p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="md:col-span-2">
                    <Label htmlFor="landLocation" className="text-white">Land Location *</Label>
                    <Input
                      id="landLocation"
                  ...
                  <div>
                    <Label htmlFor="landArea" className="text-white">Land Area (Acres) *</Label>
                    <Input
                      id="landArea"
                      type="number"
                      placeholder="e.g., 5"
                  ...
                  <div>
                    <Label htmlFor="landType" className="text-white">Land Type *</Label>
                    <Select value={formData.landType} onValueChange={(value) => handleInputChange('landType', value)}>
                      ...
                      <SelectContent className="bg-gray-700 border-gray-600">
                        ...
                        <SelectItem value="barren" className="text-white">Barren/Wasteland</SelectItem>
                  ...
                  <div>
                    <Label htmlFor="soilType" className="text-white">Soil Type</Label>
                    <Input
                      id="soilType"
                  ...
                  <div>
                    <Label htmlFor="waterAccess" className="text-white">Water Access</Label>
                    <Select value={formData.waterAccess} onValueChange={(value) => handleInputChange('waterAccess', value)}>
                      <SelectTrigger className="bg-gray-700 border-gray-600 text-white mt-2">
                        <SelectValue placeholder="Water availability" />
                      </SelectTrigger>
                      <SelectContent className="bg-gray-700 border-gray-600">
                        <SelectItem value="borewell" className="text-white">Borewell</SelectItem>
                        <SelectItem value="canal" className="text-white">Canal</SelectItem>
                        <SelectItem value="river" className="text-white">River/Stream</SelectItem>
                        <SelectItem value="none" className="text-white">No Water Source</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>

                  <div>
                    <Label htmlFor="roadAccess" className="text-white">Road Access</Label>
                    <Select value={formData.roadAccess} onValueChange={(value) => handleInputChange('roadAccess', value)}>
                      <SelectTrigger className="bg-gray-700 border-gray-600 text-white mt-2">
                        <SelectValue placeholder="Road connectivity" />
                      </SelectTrigger>
                      <SelectContent className="bg-gray-700 border-gray-600">
                        <SelectItem value="paved" className="text-white">Paved Road</SelectItem>
                        <SelectItem value="dirt" className="text-white">Dirt Road</SelectItem>
                        <SelectItem value="limited" className="text-white">Limited Access</SelectItem>
                        <SelectItem value="none" className="text-white">No Direct Access</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>

                  <div>
                    <Label htmlFor="electricityAccess" className="text-white">Electricity Grid Access</Label>
                    <Select value={formData.electricityAccess} onValueChange={(value) => handleInputChange('electricityAccess', value)}>
                      <SelectTrigger className="bg-gray-700 border-gray-600 text-white mt-2">
                        <SelectValue placeholder="Grid connectivity" />
                      </SelectTrigger>
                      <SelectContent className="bg-gray-700 border-gray-600">
                        <SelectItem value="connected" className="text-white">Grid Connected</SelectItem>
                        <SelectItem value="nearby" className="text-white">Grid Nearby (&lt;1km)</SelectItem>
                        <SelectItem value="distant" className="text-white">Grid Distant (&gt;1km)</SelectItem>
                        <SelectItem value="none" className="text-white">No Grid Access</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                ...
                <div className="space-y-6">
                  <div>
                    <Label htmlFor="landTitle" className="text-white">Land Title/Registry Number *</Label>
                    <Input
                      id="landTitle"
                  ...
                  <div>
                    ...
                    <div className="mt-2 p-4 border-2 border-dashed border-gray-600 rounded-lg text-center">
                      ...
                      <p className="text-gray-400 text-sm">Upload land title, sale deed, patta documents</p>
                      <input
                        type="file"
                        multiple
                        className="hidden"
                  ...
                  <div>
                    ...
                    <div className="mt-2 p-4 border-2 border-dashed border-gray-600 rounded-lg text-center">
                      <Upload className="w-8 h-8 text-gray-400 mx-auto mb-2" />
                      <p className="text-gray-400 text-sm">Upload survey settlement, boundary maps</p>
                      <input
                        type="file"
                        multiple
                        className="hidden"
                        id="surveyDocuments"
                        onChange={(e) => handleFileUpload('surveyDocuments', e.target.files?.[0] || null)}
                      />
                      <Button
                        type="button"
                        variant="outline"
                  ...
                  <div>
                    ...
                    <div className="mt-2 p-4 border-2 border-dashed border-gray-600 rounded-lg text-center">
                      <Upload className="w-8 h-8 text-gray-400 mx-auto mb-2" />
                      <p className="text-gray-400 text-sm">NOC from village panchayat, pollution board clearances</p>
                      <input
                        type="file"
                        multiple
                        className="hidden"
            ...
            {currentStep === 4 && (
              <div className="space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <Label htmlFor="compensationPreference" className="text-white">Compensation Preference *</Label>
                    <Select value={formData.compensationPreference} onValueChange={(value) => handleInputChange('compensationPreference', value)}>
                      <SelectTrigger className="bg-gray-700 border-gray-600 text-white mt-2">
                  ...
                  <div>
                    <Label htmlFor="expectedDuration" className="text-white">Expected Partnership Duration (Years)</Label>
                    <Input
                      id="expectedDuration"
                      type="number"
                      placeholder="e.g., 25"
                  ...
                  <div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => handleInputChange('previousPartnership', checked)}
                        className="border-gray-600"
                      />
                  ...
                  {formData.previousPartnership && (
                    <div>
                      <Label htmlFor="experience" className="text-white">Previous Experience Details</Label>
                      <Textarea
                        id="experience"
            ...
            {currentStep === 5 && (
              <div className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-400">Review your partnership application before submission</p>
                </div>
