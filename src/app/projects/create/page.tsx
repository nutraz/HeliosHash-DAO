...
import { ArrowLeft, Upload, MapPin, Zap, IndianRupee, Users, Calendar, FileText, AlertCircle } from 'lucide-react';
          ...
          <CardContent className="p-6">
            ...
            {currentStep === 2 && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <Label htmlFor="capacity" className="text-white">Capacity (MW) *</Label>
                    <Input
                      id="capacity"
                      type="number"
                      placeholder="e.g., 50"
                  ...
                  <div>
                    <Label htmlFor="technology" className="text-white">Solar Technology *</Label>
                  ...
                  <div>
                    <Label htmlFor="estimatedCost" className="text-white">Estimated Cost (₹ Crores) *</Label>
                    <Input
                      id="estimatedCost"
                      type="number"
                      placeholder="e.g., 25"
                  ...
                  <div>
                    <Label htmlFor="estimatedReturn" className="text-white">Estimated Return (%)</Label>
                    <Input
                      id="estimatedReturn"
                      type="number"
                      placeholder="e.g., 12"
                  ...
                  <div>
                    <Label htmlFor="timeline" className="text-white">Project Timeline (months)</Label>
                    <Input
                      id="timeline"
                      type="number"
                      placeholder="e.g., 18"
                  ...
                  <div>
                    <Label htmlFor="gridConnection" className="text-white">Grid Connection Type</Label>
                    <Select value={formData.gridConnection} onValueChange={(value) => handleInputChange('gridConnection', value)}>
                      <SelectTrigger className="bg-gray-700 border-gray-600 text-white mt-2">
                        <SelectValue placeholder="Select connection type" />
                      </SelectTrigger>
                      <SelectContent className="bg-gray-700 border-gray-600">
                        <SelectItem value="on-grid" className="text-white">On-Grid</SelectItem>
                        <SelectItem value="off-grid" className="text-white">Off-Grid</SelectItem>
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <Label htmlFor="landOwnership" className="text-white">Land Ownership *</Label>
                    <Select value={formData.landOwnership} onValueChange={(value) => handleInputChange('landOwnership', value)}>
                      ...
                      <SelectContent className="bg-gray-700 border-gray-600">
                        ...
                        <SelectItem value="leased" className="text-white">Leased</SelectItem>
                        <SelectItem value="government" className="text-white">Government Land</SelectItem>
                        <SelectItem value="community" className="text-white">Community Land</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>

                  <div className="md:col-span-2">
                    <Label htmlFor="landDocuments" className="text-white">Land Documents</Label>
                    <div className="mt-2 p-4 border-2 border-dashed border-gray-600 rounded-lg text-center">
                      <Upload className="w-8 h-8 text-gray-400 mx-auto mb-2" />
                      <p className="text-gray-400 text-sm">Upload land title, survey documents, NOCs</p>
                      <input
                        type="file"
                        multiple
                        className="hidden"
                        id="landDocuments"
                        onChange={(e) => handleFileUpload('landDocuments', e.target.files?.[0] || null)}
                      />
                      <Button
                        type="button"
                        variant="outline"
                  ...
                  <div>
                    <Label htmlFor="environmentalClearance" className="text-white">Environmental Clearance</Label>
                    <Select value={formData.environmentalClearance} onValueChange={(value) => handleInputChange('environmentalClearance', value)}>
                      <SelectTrigger className="bg-gray-700 border-gray-600 text-white mt-2">
                        <SelectValue placeholder="Select status" />
                      </SelectTrigger>
                      <SelectContent className="bg-gray-700 border-gray-600">
                        <SelectItem value="obtained" className="text-white">Obtained</SelectItem>
                        <SelectItem value="in-progress" className="text-white">In Progress</SelectItem>
                        <SelectItem value="not-required" className="text-white">Not Required</SelectItem>
                        <SelectItem value="pending" className="text-white">Pending Application</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
            ...
            {currentStep === 4 && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <Label htmlFor="fundingGoal" className="text-white">Funding Goal (₹ Crores) *</Label>
                    <Input
                      id="fundingGoal"
                      type="number"
                      placeholder="e.g., 20"
                  ...
                  <div>
                    <Label htmlFor="maxInvestors" className="text-white">Maximum Investors</Label>
                    <Input
                      id="maxInvestors"
                      type="number"
                ...
                <div className="space-y-4">
                    ...
                    <CardContent>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <span className="text-white ml-2">{formData.location}, {formData.state}</span>
                        </div>
                        <div>
                  ...
                  <Alert className="border-orange-500/50 bg-orange-500/10">
                    ...
                    <AlertDescription className="text-orange-400">
                      By submitting this project, you agree to HeliosHash DAO's terms and conditions. 
                      Your project will be reviewed by the community before going live.
                    </AlertDescription>
                  </Alert>
                </div>
              </div>
