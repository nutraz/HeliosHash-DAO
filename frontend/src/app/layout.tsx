...
export const metadata = {
  ...
  icons: {
    icon: ['/favicon.ico', '/assets/icons/helioshash-color.svg', '/assets/icons/helioshash.svg'],
    apple: '/assets/icons/helioshash-color.svg'
  },
}
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="icon" href="/assets/icons/helioshash-color.svg" />
