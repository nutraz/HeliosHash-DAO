      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8" data-testid="dashboard-header">
            ...
            {user?.isWoman && (
              <div className="mt-4 inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-pink-100 text-pink-800" data-testid="women-bonus-badge">
                20% Bonus
              </div>
            )}
          </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow" data-testid="governance-section">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded text-xs">Voting</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Community Fund</span>
                    <span className="bg-green-100 text-green-800 px-2 py-1 rounded text-xs">Passed</span>
                  </div>
                </div>
              </div>
            </div>
