export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'finalizeDispute' : IDL.Func(
        [DisputeId, IDL.Text, IDL.Bool],
        [Result_1],
        [],
      ),
    ...
    'getDisputesByCategory' : IDL.Func(
        [DisputeCategory],
        [IDL.Vec(Dispute)],
        ['query'],
      ),
    ...
    'getMediationSessions' : IDL.Func(
        [DisputeId],
        [IDL.Vec(MediationSession)],
        ['query'],
      ),
    ...
    'scheduleMediationSession' : IDL.Func(
        [DisputeId, Time, IDL.Vec(IDL.Principal)],
        [Result],
        [],
      ),
    'submitEvidence' : IDL.Func(
        [DisputeId, IDL.Text, EvidenceType],
        [Result],
        [],
      ),
  });
